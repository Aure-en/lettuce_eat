...
const TextEditor = forwardRef(
  ({ sendContent, prevContent, placeholder }: Props, ref) => {
    ...
    // If we provide a previous content (i.e : we are editing a comment / post),
    // it is loaded in the Text Editor.
    useEffect(() => {
...
const Button = styled.button<{
  ...
  background: ${(props) => props.active && props.theme.text_editor_button_hover};
